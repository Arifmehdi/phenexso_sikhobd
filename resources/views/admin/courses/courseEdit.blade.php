...
<section class="content py-3">
    <div class="row">
        <div class="col-md-11 mx-auto">
            ...
            {{-- Course Edit Form --}}
            <form action="{{ route('admin.courseUpdate', $course) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="name_en">Course Name
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="name_en" 
                                           value="{{ old('name_en', $course->name_en) }}" 
                                           class="form-control" placeholder="Course Name (English)" 
                                ...
                                <div id="course_fields" style="border: 1px dashed var(--primary); padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="duration" value="{{ old('duration', $course->duration) }}" class="form-control" placeholder="Duration">
                                    </div>
                                    <div class="form-group">
                                        <label for="lessons_count">Total Lessons (Classes)</label>
                                        <input type="number" name="lessons_count" value="{{ old('lessons_count', $course->lessons_count ?? 0) }}" class="form-control" placeholder="Total Lessons">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="selling_price"  class="form-control" placeholder="Enter course fee" value="{{ $course->selling_price ?? '' }}" required>
                                    @error('selling_price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt_en" id="excerpt_en" class="form-control" rows="2" placeholder="Excerpt">{{ old('excerpt_en', $course->excerpt_en) }}</textarea>
                                </div>

                                {{-- Description --}}
                                <div class="form-group">
                                    <label for="description_en">Description</label>
                                    <textarea name="description_en" id="summernote" class="form-control summernote" rows="5" placeholder="Description">{{ old('description_en', $course->description_en) }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="mr-3">
                                        <input type="checkbox" name="feature" {{ $course->feature ? 'checked' : '' }}> Featured
                                    </label>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="category-area">
                                            ...
                                            <div class="custom-control custom-checkbox bg-light rounded-lg mb-1">
                                                <input type="checkbox"
                                                       ...
                                                       name="categories[]"
                                                       value="{{ $cat->id }}"
                                                       {{ in_array($cat->id, $course->categories()->pluck('product_category_id')->toArray()) ? 'checked' : '' }}>
