                        ...
                        <div class="card card-primary card-outline margin-bottom">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control-file" id="feature_image" name="featured_image" accept="image/*" value="{{ old('featured_image') }}">
                                        ...
                                        <img src="{{ route('imagecache', ['template' => 'ppsm', 'filename' => $product->fi()]) }}" alt="Featured Image" class="mt-2" style="max-height:120px;">
                                    </div>
                                </div>
